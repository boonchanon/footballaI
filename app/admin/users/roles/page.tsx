...
const roles = [
  ...
  },
  {
    id: 2,
    name: "Admin",
    description: "Manage users, content, and basic settings",
    userCount: 5,
    color: "bg-orange-500",
  ...
  },
  {
    id: 3,
    name: "Editor",
    description: "Create and edit content, manage matches and teams",
    userCount: 12,
    color: "bg-blue-500",
    permissions: ["content.manage", "matches.manage", "teams.manage"],
    isSystem: false,
  },
  {
    id: 4,
    name: "Moderator",
    description: "Moderate community content and comments",
    userCount: 8,
    color: "bg-purple-500",
    permissions: ["community.moderate", "content.view"],
    isSystem: false,
  },
  {
    id: 5,
    ...
    userCount: 1250,
    color: "bg-gray-500",
    permissions: ["content.view", "community.participate"],
    isSystem: true,
  },
]
