...
import { getTopAssists, translateTeamName } from "@/lib/sportmonks"
...
export async function GET() {
  try {
      ...
      statistics: [
        {
          ...
          goals: {
            total: item.player?.statistics?.[0]?.details?.find((d: any) => d.type_id === 52)?.value || 0,
    ...
    const fallback = [
      ...
      { id: "874", name: "Kevin De Bruyne", photo: "https://media.api-sports.io/football/players/874.png", team: "แมนเชสเตอร์ ซิตี้", teamLogo: "https://media.api-sports.io/football/teams/50.png", goals: 5, assists: 9, apps: 18, pos: "กองกลาง" },
