...
const outDir = path.join(root, ".tmp-temporary-room-tests")
...
const run = spawnSync("node", ["--test", path.join(outDir, "tests", "temporary-rooms.test.js")], {
  cwd: root,
  stdio: "inherit",
  env: process.env,
})
